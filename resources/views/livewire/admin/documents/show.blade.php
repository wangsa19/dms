                ...
                <div class="mb-6 bg-gray-50 border border-gray-200 rounded-lg p-4 dark:bg-gray-800/50 dark:border-gray-700">
                    ...
                    <form wire:submit.prevent="uploadVersion" class="flex flex-col sm:flex-row gap-4 items-start sm:items-end">
                        ...
                        <div class="flex-grow w-full">
                            ...
                            <input wire:model="newRevisionNotes" type="text" placeholder="e.g. Updated standard procedure" class="w-full text-sm border border-gray-300 rounded bg-white py-1.5 px-3 focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500">
