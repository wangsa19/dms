                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 text-gray-600">
                        <tr>
                            ...
                            <th class="p-3 text-left font-semibold whitespace-nowrap">Document Category</th>
                            <th class="p-3 text-left font-semibold whitespace-nowrap">Borrowed By</th>
                            <th class="p-3 text-left font-semibold whitespace-nowrap">Borrowed NIK</th>
                    ...
                    <tbody class="divide-y divide-gray-200 text-gray-700">
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3 align-middle whitespace-nowrap">001135</td>
                            <td class="p-3 align-middle whitespace-nowrap">2025-01-26 11:46:00</td>
                            <td class="p-3 align-middle whitespace-nowrap">2025-02-26 09:31:59</td>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3 align-middle whitespace-nowrap">ELY SUYANTI</td>
                            <td class="p-3 align-middle whitespace-nowrap">001135</td>
                            <td class="p-3 align-middle whitespace-nowrap">2025-02-01 13:31:00</td>
                            <td class="p-3 align-middle whitespace-nowrap">2025-02-01 09:31:57</td>
                            <td class="p-3 align-middle whitespace-nowrap">
                                <button class="text-gray-500 hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
