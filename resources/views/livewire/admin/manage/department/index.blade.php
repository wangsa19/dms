            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 text-gray-700">
                        @php
                            $departments = [
                                ['id' => 1, 'name' => 'ENGINEERING', 'code' => null],
                                ['id' => 2, 'name' => 'FA', 'code' => null],
                                ['id' => 3, 'name' => 'IC - WAREHOUSE', 'code' => null],
                                ['id' => 4, 'name' => 'MAINTENANCE', 'code' => null],
                                ['id' => 5, 'name' => 'NYS', 'code' => null],
                                ['id' => 6, 'name' => 'PGA', 'code' => null],
                                ['id' => 7, 'name' => 'PPIC', 'code' => null],
                                ['id' => 8, 'name' => 'PRODUCTION PREPARATION', 'code' => null],
                                ['id' => 9, 'name' => 'PRODUKSI', 'code' => null],
                                ['id' => 10, 'name' => 'QUALITY ASSURANCE', 'code' => null],
                            ];
                        @endphp
                        @foreach ($departments as $index => $department)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="p-3 align-middle whitespace-nowrap">{{ $department['name'] }}</td>
