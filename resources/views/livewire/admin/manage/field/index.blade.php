<div>
    {{-- Breadcrumbs --}}
    <div class="text-sm text-gray-500 mb-4">Manage > Field</div>

    {{-- Main Title --}}
    <h1 class="text-3xl font-bold text-gray-800 mb-6">FIELD</h1>

    {{-- Main Content Card --}}
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        {{-- Card Header --}}
        <div class="px-5 py-4 border-b border-gray-200 flex justify-between items-center flex-wrap gap-y-4">
            <h5 class="font-semibold text-lg text-gray-800">Manage Field</h5>
            {{-- Tombol Create --}}
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 text-gray-600">
                        <tr>
                            ...
                            {{-- <th class="p-3 text-left font-semibold whitespace-nowrap">Field ID</th> --}}
                    ...
                    <tbody class="divide-y divide-gray-7index.bl00 text-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-3 align-middle whitespace-nowrap">{{ $fields->firstItem() + $index }}</td>
                            {{-- <td class="p-3 align-middle whitespace-nowrap">{{ $field->id }}</td> --}}
                            <td class="p-3 align-middle whitespace-nowrap font-medium">{{ $field->name }}</td>
                            <td class="p-3 align-middle whitespace-nowrap">{{ $field->code ?? '-' }}</td>
                        ...
                        <tr>
                            <td colspan="5" class="text-center p-4 text-gray-500">No fields found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <form wire:submit.prevent="save">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="name" wire:model="name" placeholder="Enter field name"
                    ...
                    <div>
                        ...
                        <input id="code" wire:model="code" type="text" placeholder="Enter field code (Optional)"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 mt-1 text-sm focus:ring-2 focus:ring-blue-500">
                        @error('code')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                        @enderror
