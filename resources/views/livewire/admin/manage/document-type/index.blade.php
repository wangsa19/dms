<div>
    {{-- Breadcrumbs --}}
    <div class="text-sm text-gray-500 mb-4">Manage > Document Type</div>

    {{-- Main Title --}}
    <h1 class="text-3xl font-bold text-gray-800 mb-6">DOCUMENT TYPE</h1>

    {{-- Main Content Card --}}
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        {{-- Card Header --}}
        <div class="px-5 py-4 border-b border-gray-200 flex justify-between items-center flex-wrap gap-y-4">
            <h5 class="font-semibold text-lg text-gray-800">Manage Document Type</h5>
            {{-- Tombol Create --}}
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 text-gray-600">
                        <tr>
                            ...
                            {{-- <th class="p-3 text-left font-semibold whitespace-nowrap">Document Type ID</th> --}}
                    ...
                    <tbody class="divide-y divide-gray-700 text-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="p-3 align-middle whitespace-nowrap">{{ $documentTypes->firstItem() + $index }}
                            </td>
                            {{-- <td class="p-3 align-middle whitespace-nowrap">{{ $type->id }}</td> --}}
                            <td class="p-3 align-middle whitespace-nowrap font-medium">{{ $type->name }}</td>
                            <td class="p-3 align-middle whitespace-nowrap">{{ $type->code ?? '-' }}</td>
                        ...
                        <tr>
                            <td colspan="5" class="text-center p-4 text-gray-500">No document types found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div class="fixed inset-0 bg-black/40 flex items-center justify-center z-50 ">
        <div class="bg-white w-full max-w-lg rounded-xl p-6 shadow-lg">
            <h3 class="text-xl font-bold text-gray-800 mb-6">
                {{ $documentTypeId ? 'Edit Document Type' : 'Create New Document Type' }}
            </h3>
            ...
            <form wire:submit.prevent="save">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="name" wire:model="name" placeholder="Enter document type name"
                    ...
                    <div>
                        ...
                        <input id="code" wire:model="code" type="text" placeholder="Enter document type code (Optional)"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 mt-1 text-sm focus:ring-2 focus:ring-blue-500">
                        @error('code')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                        @enderror
