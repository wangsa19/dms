            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 text-gray-700">
                        @php
                        $documentTypes = [
                        ['id' => 1, 'name' => 'License', 'code' => null],
                        ['id' => 2, 'name' => 'Report', 'code' => null],
                        ['id' => 3, 'name' => 'Registration', 'code' => null],
                        ['id' => 4, 'name' => 'Notification', 'code' => null],
                        ['id' => 5, 'name' => 'Training', 'code' => null],
                        ];
                        @endphp
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3 align-middle whitespace-nowrap">{{ $type['name'] }}</td>
