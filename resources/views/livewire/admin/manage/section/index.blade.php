        ...
        <div class="p-5">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 text-gray-700">
                        @php
                        $sections = [
                        ['id' => 1, 'name' => 'ACCOUNTING', 'code' => null],
                        ['id' => 2, 'name' => 'ACCOUNTING (TAX)', 'code' => null],
                        ['id' => 3, 'name' => 'DESIGN & STANDARD ENGINEERING', 'code' => null],
                        ['id' => 4, 'name' => 'EKIM', 'code' => null],
                        ['id' => 5, 'name' => 'FA', 'code' => null],
                        ['id' => 6, 'name' => 'GENERAL AFFAIR', 'code' => null],
                        ['id' => 7, 'name' => 'HUMAN RESOURCES', 'code' => null],
                        ['id' => 8, 'name' => 'INDUSTRIAL RELATION', 'code' => null],
                        ['id' => 9, 'name' => 'INFORMATION TECHNOLOGY', 'code' => null],
                        ['id' => 10, 'name' => 'MAINTENANCE', 'code' => null],
                        ];
                        @endphp
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3 align-middle whitespace-nowrap">{{ $section['name'] }}</td>
            ...
            <div class="flex justify-between items-center mt-4 text-sm">
                ...
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    ...
                    <a href="#"
                        class="px-4 py-2 text-gray-700 bg-white border-t border-b border-gray-300 hover:bg-gray-50 text-sm font-medium">2</a>
                    <a href="#"
