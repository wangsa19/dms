        ...
        <div class="p-5">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 text-gray-700">
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3 align-middle whitespace-nowrap">action-frequency-create</td>
                            <td class="p-3 align-middle whitespace-nowrap">web</td>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3 align-middle whitespace-nowrap">action-frequency-delete</td>
                            <td class="p-3 align-middle whitespace-nowrap">web</td>
                            <td class="p-3 align-middle whitespace-nowrap">
                                <button class="text-gray-500 hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3 align-middle whitespace-nowrap">action-frequency-edit</td>
                            <td class="p-3 align-middle whitespace-nowrap">web</td>
                            <td class="p-3 align-middle whitespace-nowrap">
                                <button class="text-gray-500 hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="p-3 align-middle whitespace-nowrap">4</td>
                            <td class="p-3 align-middle whitespace-nowrap">category-create</td>
                            <td class="p-3 align-middle whitespace-nowrap">web</td>
                            <td class="p-3 align-middle whitespace-nowrap">
                                <button class="text-gray-500 hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="p-3 align-middle whitespace-nowrap">5</td>
                            <td class="p-3 align-middle whitespace-nowrap">category-delete</td>
                            <td class="p-3 align-middle whitespace-nowrap">web</td>
                            <td class="p-3 align-middle whitespace-nowrap">
                                <button class="text-gray-500 hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
            ...
            <div class="flex justify-between items-center mt-4 text-sm">
                ...
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    ...
                    <a href="#"
                        class="px-4 py-2 text-gray-700 bg-white border-t border-b border-gray-300 hover:bg-gray-50 text-sm font-medium">1</a>
                    <a href="#"
                        class="px-4 py-2 border-t border-b border-gray-300 bg-blue-600 text-white z-10 text-sm font-bold">2</a>
                    <a href="#"
                        class="px-4 py-2 text-gray-700 bg-white border-t border-b border-gray-300 hover:bg-gray-50 text-sm font-medium">3</a>
                    <a href="#"
